# Verify/Check Mode for `setup-sk-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-sk-skills`.
...
- #106: Feature request: verify/check mode for setup-sk-skills
