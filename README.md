...
| **[setup-statusline](./skills/productivity/setup-statusline/SKILL.md)** | Productivity | User-invoked | Install the custom terminal status line across your coding agents: the full renderer for Claude Code and GitHub Copilot CLI, and the closest built-in approximation for Codex. |
