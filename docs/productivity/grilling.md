...
| How long a session should run, what to do with a question you can't answer by talking, how to avoid nodding along | grill-me |
| What gets written to `CONTEXT.md`, what becomes an ADR | grill-with-docs |
