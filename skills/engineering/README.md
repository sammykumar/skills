...
- **[openscad-lsp](./openscad-lsp/SKILL.md)**: What the OpenSCAD language server wired into this plugin can and cannot answer: cross-file go-to-definition works, find references does not exist, rename is single-file, and diagnostics are syntax only.
